...
const IssueDetail = () => {
  ...
  return (
    <Layout>
      {/* Breadcrumb */}
      <nav className="flex items-center gap-2 mb-8 text-xs font-label uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <section className="space-y-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-xs ml-auto" style={{ color: 'var(--text-muted)' }}>Issue #{issue.id}</span>
            </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="p-6 rounded-xl space-y-3" style={{ backgroundColor: 'var(--surface-raised)' }}>
            <h3 className="text-xs font-label uppercase tracking-widest mb-4" style={{ color: 'var(--text-muted)' }}>Quick Actions</h3>
            <button
          ...
          <div className="bg-surface-container-lowest p-6 rounded-xl ambient-shadow border border-outline-variant/10">
            <h3 className="text-xs font-label uppercase tracking-widest mb-4" style={{ color: 'var(--text-muted)' }}>Issue Details</h3>
            <div className="space-y-4">
